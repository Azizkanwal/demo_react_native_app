...
- `src`: This folder is the main container of all the code inside your application.
    ...
    - `components`: Folder to store (screens/features) component that you use through your app
    - `helper`: Folder that contains all your application helper functions.
    - `store`: Folder to put all redux middlewares and the store.
    - `Routes`: Main component that store all routes of your whole app.
    - `App.js`: Main component that starts your whole app.
    - `config.js`: Use for configure the variable deceleration.
    - `redux`:    
        - `services`: This folder contains all api's that can be get response.
        - `slices`: This folder contains all actions that can be dispatched to redux.
        - `store.js`: This file put all redux middlewares and the store.
...
### Redux folders and files

- Store: Here you define the store shape and you can configure the persistReducer and middlewares.

2 folders divide the redux work

- Slices: Remember to create the file and the corresponding test for each action classification. Here you define actions for success and error scenarios.
- Services: here you can define all your apis.
